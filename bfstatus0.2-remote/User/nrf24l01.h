...
#define NRF_CE_HIGH()	      GPIO_SetBits(GPIOB,GPIO_Pin_14)
#define NRF_CE_LOW()	      GPIO_ResetBits(GPIOB,GPIO_Pin_14)			      //CE置低
#define NRF_Read_IRQ()		  GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_15)  //中断引脚
