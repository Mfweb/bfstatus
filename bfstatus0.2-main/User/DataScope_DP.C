...
{
	uint16_t i,count;
	DataScope_Get_Channel_Data(Angle.angle.Pitch,1);
	DataScope_Get_Channel_Data(Angle.angle.Roll,2);
	DataScope_Get_Channel_Data(Angle.angle.Yaw,3);
	count = DataScope_Data_Generate(3);
	for(i=0;i<count;i++)
	{
